...
const Objetivo objetivos[NUM_OBJETIVOS] = {
    {"Cura", "Clarividência", 
    ...
    {"Cura", "Proteção", 
     "Com mãos suaves, a cura será trazida, mas em um campo de batalha invisível, onde o mal espreita, "
     "um escudo protetor deve ser erguido. Que a força das estrelas envolva teu familiar, curando e defendendo ao mesmo tempo."},
    ...
    {"Clarividência", "Proteção", 
     "O futuro está diante de teus olhos, mas, para atravessá-lo sem que o mal se coloque no teu caminho, "
     "uma barreira deve ser erguida. Que a proteção divina envolva quem precisas, enquanto a visão do futuro te guia."},

    {"Clarividência", "Energia", 
    ...
    {"Proteção", "Energia", 
     "Em tempos de necessidade, a proteção é como uma fortaleza, mas a energia é a chave para mantê-la de pé. "
     "Que o vigor seja transmitido ao teu aliado, para que o escudo mágico se fortaleça ainda mais contra as sombras."}
};
